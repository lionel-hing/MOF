...
def init_weights(net):
    init_type, init_param = 'xavier', 1.0
...
class ReparamModule(nn.Module):
    ...
    def forward_with_param(self, text_data, video_data, new_w):
        with self.unflatten_weight(new_w):
            return nn.Module.__call__(self, text_data, video_data)

    def __call__(self, text_data, video_data):
        return self.forward_with_param(text_data, video_data, self.flat_w)
